...
@Component({ selector: 'dashboard-job-table', templateUrl: 'job-table.component.html', styleUrls: ['job-table.component.css'] })
export class JobDashboardComponent {
  ...
  ngOnInit() {
    ...
    this.dataSourceJobs.paginator = this.paginator;
   }
